...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Rushikesh.</span> I&apos;m a{" "}
        <span className="font-bold">MERN stack developer</span>.My focus is{" "}
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/rushikeshchorge/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Rushichorge17"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
